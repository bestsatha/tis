...
<head>
  ...
  <title>Member - UnivLiner TIS</title>
...
include("menuweb/sidebaradmin.php"); ?>
  ...
  <main id="main" class="main">
    ...
    <br><br>
    <form action="member_insert.php" method="POST" enctype="multipart/form-data" id="member_frm">

<div class="row g-3">
<div class="col-md-4">
<label for="form-label">รูปถ่าย</label>
        <input class="form-control form-control-lg" id="member_image" name="member_image" type="file">
    </div>
    <div class="col-md-4">
