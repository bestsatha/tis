    ...
    <table id="example3" class="table table-bordered table-striped dataTable">
        <thead>
            <tr role="row" class="info">
                ...
                <th tabindex="0" rowspan="1" colspan="1" style="width: 15%;">เวลาเข้างาน</th>
                <th tabindex="0" rowspan="1" colspan="1" style="width: 15%;">เวลาออกงาน</th>
                <th tabindex="0" rowspan="1" colspan="1" style="width: 20%;">เข้างาน/ออกงาน</th>
            </tr>
            <?php
    for($i=1;$i<=1;$i++){
  ?>
            ...
            $sql = "SELECT * FROM work_io ORDER BY workdate DESC limit {$start} , {$perpage}";
    ...
    <table id="example3" class="table table-bordered table-striped dataTable">
        <thead>
            <tr role="row" class="info">
                ...
                <th tabindex="0" rowspan="1" colspan="1" style="width: 20%;">ท่าปล่อยรถ</th>
                <th tabindex="0" rowspan="1" colspan="1" style="width: 5%;">สายที่</th>
                <th tabindex="0" rowspan="1" colspan="1" style="width: 15%;">หมายเลขรถ</th>
                <th tabindex="0" rowspan="1" colspan="1" style="width: 30%;">พนักงานขับรถ</th>
                <th tabindex="0" rowspan="1" colspan="1" style="width: 20%;">เวลาที่เข้าสถานี</th>
