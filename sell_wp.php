...
<body>
    ...
    <main id="main" class="main">
        <center>
            <h3>ระบบขายบัตรโดยสารรายสัปดาห์</h3>
        </center>
        ...
        <input type="text" class="form-control" id="mp_datesell" name="mp_datesell" value="<?php echo date('d/m/Y');?>" placeholder="">  
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" aria-label="Default select example" name="mp_year" id="mp_year">
                        <option value="สัปดาห์ที่ 1 (วันที่ 1-7)">สัปดาห์ที่ 1 (วันที่ 1-7)</option>
                        <option value="สัปดาห์ที่ 2 (วันที่ 8-14)">สัปดาห์ที่ 2 (วันที่ 8-14)</option>
                        <option value="สัปดาห์ที่ 3 (วันที่ 15-21)">สัปดาห์ที่ 3 (วันที่ 15-21)</option>
                        <option value="สัปดาห์ที่ 4 (วันที่ 22-สิ้นเดือน)">สัปดาห์ที่ 4 (วันที่ 22-สิ้นเดือน)</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <h4>เลือกเดือน</h4>
