...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  include('admin/config/condb.php');
    ...
    $ps_id = mysqli_real_escape_string($conn, $_GET['driver_id']);
...
include("menuweb/sidebar.php"); ?>
  ...
  <div class="container mt-3">
        ...
        <form action="driver_edit.php" method="POST" enctype="multipart/form-data" name="person_frm" id="person_frm">
            <div class="row g-3">
                <div class="col-md-4">
                    <label for="form-label">รหัสประจำตัว</label>
                    <input type="text" class="form-control" id="driver_id" name="driver_id" value="<?php echo $driver_id; ?>" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="driver_surname" name="driver_surname" value="<?php echo $driver_surname; ?>" required>
                </div>
                <div class="col-md-4">
