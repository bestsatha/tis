...
<label for="form-label">รูปถ่ายหน้าตรง</label>
    ...
    <div class="col-md-4">
        ...
        <select class="form-select" aria-label="Default select example" name="pst_id" id="pst_id">
                        ...
                        ?>
                            <option value="<?= $row["pst_name"]; ?>"><?= $row["pst_id"] . " - " . $row["pst_name"]; ?></option>
    ...
    <div class="col-md-4">
        ...
        <input type="hidden" name="hd_driver_id">
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        ...
        <select class="form-select" aria-label="Default select example" name="driver_prefix" id="driver_prefix">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="driver_surname" name="driver_surname">
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        ...
        <select class="form-select" aria-label="Default select example" name="driver_gender">
							<option value="-1">-- กรุณาเลือก --</option>
    ...
    <div class="col-md-4">
        ...
        <select class="form-select" aria-label="Default select example" name="district_id" id="district" class="form-control">
                            <option value="">เลือกตำบล</option>
                        </select>
    </div>
    <div class="col-md-4">
        <label for="form-label">เขต/อำเภอ</label>
        <select class="form-select" aria-label="Default select example" name="amphure_id" id="amphure" class="form-control">
    ...
    <div class="col-md-4">
        ...
        <select class="form-select" aria-label="Default select example" name="province_id" id="province" class="form-control">
